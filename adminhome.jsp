...
<br>
<br>
<li>*&nbsp;<a text href="studentadmin.jsp" style="font-weight:bold">STUDENT</a></li>
<br>
<li>*&nbsp;<a href="teacherdeta.jsp" style="font-weight:bold">TEACHER</a></li>
<br>
<li>*&nbsp;<a href="viewfeedback.jsp" style="font-weight:bold">FEEDBACK</a></li>
<br>
<li>*&nbsp;<a href="timetabahome.jsp" style="font-weight:bold">TIME TABLE</a></li>
<li>*&nbsp;<a href="notify.jsp" style="font-weight:bold">NOTIFICATIONS</a></li>
</ul>
</center>
</div>
 <div class="footer">
