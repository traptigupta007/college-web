...
function deleteRecord(id){
    ...
    f.action='deleteteach.jsp?id='+id;
    f.submit();
}
</script>
<body>
...
<table border="4">
<tr><th>ID</th><th>NAME</th><th>QUAL</th><th>CONTACT</th><th>EMAIL</th><th>FNAME</th><th>MNAME</th><th>AADHAR</th><th>EXP</th><th>ADDRESS</th><th>ACCOUNT</th><th>DOB</th><th>GEND</th></tr>
<%
Connection con=null;
int sumcount=0;
Statement st;
...
<br>
<center>
<a href="addnewteach.jsp">ADD NEW TEACHER</a>
</center></div>
<div class="footer">
