...
<form method="get" action="stuupdate.jsp">
...
String query = "select * from studenttab where id='"+no+"'";
...
<tr><td>Father Name</td><td><input type="text" name="fname" value="<%=rs.getString(4)%>"></td></tr>
<tr><td>Mother Name</td><td><input type="text" name="mname" value="<%=rs.getString(5)%>"></td></tr>
<tr><td>DOB</td><td><input type="text" name="dob" value="<%=rs.getString(6)%>"></td></tr>
<tr><td>Contact No</td><td><input type="text" name="cont" value="<%=rs.getString(7)%>"></td></tr>
...
<tr><td>Marks of X</td><td><input type="text" name="markst" value="<%=rs.getString(10)%>"></td></tr>
<tr><td>Passing year of X</td><td><input type="text" name="yeart" value="<%=rs.getString(11)%>"></td></tr>
<tr><td>Marks of XII</td><td><input type="text" name="marksw" value="<%=rs.getString(12)%>"></td></tr>
<tr><td> Passing Year of XII</td><td><input type="text" name="yearw" value="<%=rs.getString(13)%>"></td></tr>
<tr><td>Income</td><td><input type="text" name="income" value="<%=rs.getString(14)%>"></td></tr>
<tr><td>Branch</td><td><input type="text" name="branch" value="<%=rs.getString(15)%>"></td></tr>
<tr><td>Year</td><td><input type="text" name="year" value="<%=rs.getString(16)%>"></td></tr>
<tr><td>Caste</td><td><input type="text" name="caste" value="<%=rs.getString(17)%>"></td></tr>
<tr> <td>Gender</td><td><input type="text" name="gender" value="<%=rs.getString(18)%>"></td></tr>
