...
<div class="topmenu">
		...
		<div class="login" >
		<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="g.jpg" height=50 width=170>
			 <form  method="post" action="teacherlogindb.jsp" >
                <table style="color:white">
                <tr><td>Teacher ID</td><td><input type="text" name="id" required="required"/></td></tr>
				<tr></tr>
                <tr><td>Password</td><td><input type="password" name="password" required="required"/></td></tr>
                <tr><td><input type="reset" value="RESET"/></td><td><input type="submit" value="SUBMIT" onclick="teacherlogindb.jsp"/></td></tr>
                <tr><td>&nbsp;&nbsp;</td></tr>
				<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><a href="addnewteach.jsp" style="color:white">SignUp</a></td></tr>
           <br>
		   </table>
