...
<div class="topmenu">
		...
		<div class="login" >
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="f.jpg" length=100 width=120>
			 <form  method="post" action="studentlogindb.jsp" >
                <table style="color:white">
                <tr><td>Student ID</td><td><input type="text" name="id" required="required"/></td></tr>
				<tr></tr>
                <tr><td>Password</td><td><input type="password" name="password" required="required"/></td></tr>
                <tr><td><input type="reset" value="RESET"/></td><td><input type="submit" value="SUBMIT" onclick="StudentLogindb.jsp"/></td></tr>
                <tr><td>&nbsp;&nbsp;</td></tr>
				<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><a href="addnewstu.jsp" style="color:white">SignUp</a></td></tr>
           <br>
		   </table>
